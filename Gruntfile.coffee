    ...
    browserify:
      dev:
        files: [
          ...
          {src: 'src/js/main.coffee', dest: "#{BUILD}/js/main.js"}
        ]
        options:
          transform: ['cssify', 'jadeify', 'coffeeify']
      watch:
      ...
      dist:
        files: "<%= browserify.dev.files %>",
        options:
          transform: ['cssify', 'jadeify', 'coffeeify', 'uglifyify']

    watch:
      browserify:
        files: ['src/**/*.js', 'src/**/*.coffee', 'src/**/*.css']
